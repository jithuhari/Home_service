      ...
      <ScrollView>
        ...
        <View style={styles.labelContainer}>
             <View>
                 ...
                 <TextInput style={styles.txtInput} placeholder={'Enter full name'} placeholderTextColor='#BDBDBD'
             ...
             <View>
                 ...
                 <TextInput style={styles.txtAddr}
                 multiline={true}  
                 placeholder={'Enter your Address'} placeholderTextColor='#BDBDBD'
             ...
             <View>
                 ...
                 <TextInput style={styles.txtInput} placeholder={'Enter ID No.'} placeholderTextColor='#BDBDBD'></TextInput>
             </View>
             <View>
                 ...
                 onPress={()=>{
                  ...
                  <MaterialCommunityIcons name='file-upload-outline' color='#5F5F82' size={30} style={{marginRight:25,marginTop:2}}/>
                 </TouchableOpacity>
                 <TextInput style={styles.viewScan}
                 placeholder={'Select your File'} placeholderTextColor='#BDBDBD'>
                   {addfile}
                 </TextInput>
